...
ProcessList::ProcessList() : ptr(nullptr), len(0) {}
ProcessList::ProcessList(const ProcessList& other)
    : len(other.len), capacity(other.capacity), ptr(new Process[other.capacity]) {
...
ProcessList::ProcessList(ProcessList&& other) noexcept
    : len(other.len), capacity(other.capacity), ptr(other.ptr) {
  other.ptr = nullptr;
  other.len = 0;
  other.capacity = 0;
}
